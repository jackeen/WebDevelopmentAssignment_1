...
urlpatterns = [
    ...
    path('dashboard/students/update', views.student_upload, name='dashboard_students_upload'),
    path('dashboard/students/update/<int:pk>', views.student_update, name='dashboard_students_update'),
    ...
    path('dashboard/lectures/update/<int:pk>', views.lecture_update, name='dashboard_lectures_update'),
    ...
    path('dashboard/courses/update/<int:pk>', views.course_update, name='dashboard_courses_update'),
